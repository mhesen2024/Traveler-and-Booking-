    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 rounded-lg p-8 relative z-10">
        ...
        <section className="mb-16">
          ...
          <p className="text-lg sm:text-xl leading-relaxed text-center max-w-4xl mx-auto text-gray-200">
          ...
          <p className="text-lg sm:text-xl leading-relaxed text-center max-w-4xl mx-auto mt-6 text-gray-200">
