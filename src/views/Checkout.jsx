...
const CheckOut = () => {
  ...
  return (
    <>
      <div className="booking-page flex flex-col-reverse md:flex-row gap-4 my-[100px] px-4">
        <div className="left-column flex-1 space-y-4">
          <h1 className="text-lg md:text-xl font-semibold mx-auto md:mx-[175px] text-center md:text-left">
